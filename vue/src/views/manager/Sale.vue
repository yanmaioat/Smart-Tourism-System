  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="name" label="火车名称" show-overflow-tooltip></el-table-column>
        <el-table-column prop="trainImg" label="火车图片">
          <template #default="scope">
            <el-image style="width: 50px; height: 50px; bsale-radius: 5px" :src="scope.row.trainImg" :preview-src-list="[scope.row.img]" preview-teleported></el-image>
          </template>
        </el-table-column>
        <el-table-column prop="trainPrice" label="票价"></el-table-column>
        <el-table-column prop="trainId" label="车票ID"></el-table-column>
        <el-table-column prop="trainTime" label="发车时间"></el-table-column>
