  ...
  <div class="manager-container">
    <div class="manager-header">
      <div class="manager-header-left">
        ...
        <div class="title" style="font-size: 15px;">恩施旅游网管理后台</div>
      </div>
      ...
      <div class="manager-main-left">
        ...
        >
          ...
          <el-sub-menu index="1">
            ...
            <el-menu-item index="/manager/sale">车票信息</el-menu-item>
            <el-menu-item index="/manager/tourism">旅游商品</el-menu-item>
            <el-menu-item index="/manager/train">火车票</el-menu-item>
            <el-menu-item index="/manager/article">旅游攻略信息</el-menu-item>
            <el-menu-item index="/manager/routes">旅游地点信息</el-menu-item>
